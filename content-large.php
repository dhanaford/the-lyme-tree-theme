...
<div id="post-<?php echo esc_attr(get_the_ID()); ?>" <?php post_class('dgt-blog-item dgt-blog-grid' . $class); ?>>
	<div class="dgt-blog-item-inner">
		...
		<div class="dgt-blog-info">
			...
			<div class="dgt-blog-readmore">
				<a class="dgt-button" href="<?php echo esc_url(get_the_permalink()) ?>"><?php echo esc_html__('Read More', 'dgt-soraka'); ?></a>
			</div>
		</div>
	</div>
</div>